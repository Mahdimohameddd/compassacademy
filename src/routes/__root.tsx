...
import ogImage from "@/assets/momo.webp";
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <h1 className="text-7xl font-bold text-foreground">{t("common.pageNotFound")}</h1>
        <h2 className="mt-4 text-xl font-semibold text-foreground">{t("common.pageNotFoundTitle")}</h2>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "A modern minimalist language academy — learn with confidence.",
      },
      { property: "og:title", content: "Compass Academy" },
      { property: "og:description", content: "Learn languages with confidence — A1 to C2." },
