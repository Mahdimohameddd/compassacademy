...
const englishCourse: Course = {
  ...
  cohortSize: "Max 12 students per cohort",
  rating: 4.9,
  reviewsCount: 1250,
  lessonsCount: 100,
  assignmentsCount: 0,
  ...
  faq: [
    ...
    },
    {
      ...
      a: "All sessions are held online via Zoom. You can attend from anywhere with a stable internet connection.",
    },
  ],
};
